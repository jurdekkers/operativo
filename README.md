...
- pulsante "Cattura rapida";
- inserimento manuale diretto dentro To do, Calendario e Archivio;
- scadenza per To do e Calendario;
- priorita per To do;
- Controllo rapido ordinato per scadenza e priorita;
- To do list con storico delle cose fatte e non fatte;
- selezione "First" per mostrare le priorita nella Home;
- scheda Home "To do first";
- Archivio con cartelle realistiche;
- salvataggio di schede archivio con categoria;
- collegamento di allegati tramite selettore file Android;
- Cattura rapida con salvataggio in Inbox oppure diretto nella sezione scelta;
- scelta esplicita della destinazione: To do, Calendario o Archivio;
- destinazione salvata nel database locale, separata dal testo inserito;
...
- Beta 0.1.2: Home, Inbox, To do, Calendario, Archivio, smistamento reale su database locale, APK debug.
